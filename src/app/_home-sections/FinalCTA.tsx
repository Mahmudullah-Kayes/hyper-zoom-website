    ...
    <section id="contact" className="relative w-full py-24 bg-background border-t border-white/5 overflow-hidden scroll-mt-24">
      <div className="content-container">
          <div className="relative z-10 w-full max-w-[900px] mx-auto text-center flex flex-col items-center bg-muted border border-white/5 p-16 md:p-24 rounded-3xl overflow-hidden shadow-2xl group transition-all duration-700 hover:border-accent/40">
              ...
              >
                  <button className="group relative bg-accent border border-accent px-10 py-5 rounded-full shadow-[0_0_30px_rgba(0,122,255,0.3)] hover:scale-105 active:scale-95 transition-all duration-300">
                  ...
                  <div className="flex items-center gap-3 cursor-pointer group/reel">
