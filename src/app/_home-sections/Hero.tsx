      ...
      <div className="relative z-10 w-full px-6 md:px-12 max-w-[1300px] mx-auto pt-16">
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            <a href="#contact" className="group relative flex items-center gap-4 px-8 py-4 border border-white/10 hover:border-accent hover:bg-white/5 rounded-sm transition-all duration-300">
