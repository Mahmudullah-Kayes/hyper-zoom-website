      ...
      <div className="w-full max-w-[1300px] mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
           ...
           <div className="flex flex-col gap-6 col-span-1 lg:col-span-1">
               <Link
                ...
                >
                    HYPER<span className="text-accent underline decoration-accent/40 decoration-[2px] underline-offset-8 transition-all group-hover:decoration-accent">ZOOM</span>
                </Link>
           ...
           <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-4">
                   ...
                   <p className="text-[10px] font-bold uppercase tracking-widest text-white/20 mt-2">@HyperZoomStudio</p>
                </div>
           </div>
           ...
           <div className="flex flex-col gap-8 items-start md:items-end lg:items-end">
                ...
                <div className="flex flex-col items-start md:items-end lg:items-end gap-1">
                   <p className="text-xs font-black uppercase tracking-widest text-white">Dhaka, Bangladesh</p>
                   <p className="text-[10px] font-bold uppercase tracking-widest text-white/40 lowercase">info.skillwave@gmail.com</p>
                </div>
                <button className="flex items-center gap-3 px-6 py-3 border border-white/5 hover:border-accent/40 rounded-sm bg-white/5 transition-all text-white hover:scale-105 active:scale-95">
                   <span className="text-[9px] font-black uppercase tracking-wider text-accent leading-none">Book Strategy Call</span>
                </button>
           </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-10 border-t border-white/5 gap-6">
            <p className="text-[10px] font-black uppercase tracking-widest text-white/10 select-none">
              &copy; {currentYear} HYPERZOOM STUDIO. ALL RIGHTS RESERVED.
            </p>
